...
const roundView = (r) => (r ? { ...r, tokens: estTokens(r.auditChars) } : null)
        ...
        handler: async (req, res) => {
          ...
          try {
            ...
            if (req.method === 'GET' && path === '/memory-steward/api/rounds') {
              ...
              return send(200, { ok: true, open: openV, rounds: list, summary: { count: all.length, avgTokens: avg, lastTokens: all.length ? all[0].tokens : 0, target: 2000 } })
            }
