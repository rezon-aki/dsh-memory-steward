  ...
  return h("div", { style: Object.assign({}, card, { marginBottom: 8 }) },
    ...
    h("div", { style: { marginTop: 2 } },
      h("button", { style: btnLink, onClick: () => props.toggleOpen(it.id) },
        (props.open ? "▾ 收起" : "▸ 查看详细") + "（" + (it.ops || []).length + " 个操作）")),
    props.open
      ? h("div", { style: { marginTop: 4 } }, (it.ops || []).map((op, i) =>
...
function Panel(props) {
  ...
  const toggleOpen = (id) => setOpen((s) => Object.assign({}, s, { [id]: !s[id] }));
  ...
  return h("div", { style: { padding: "10px 12px", overflow: "auto", height: "100%" } },
    ...
    h("div", { style: Object.assign({}, card, { marginTop: 10 }) },
      ...
      h("div", { style: { marginTop: 8 } },
        (tab === "pending" ? pending : history).map((it) => h(ProposalItem, { key: it.id, item: it, act, busy, selectable: tab === "pending", checked: !!sel[it.id], toggle, open: !!open[it.id], toggleOpen })),
